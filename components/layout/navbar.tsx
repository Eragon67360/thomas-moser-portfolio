  ...
  return (
    <>
      <div className='relative flex justify-center'>
        <div className='absolute -top-10 z-[-2] mx-auto hidden h-6 w-full max-w-5xl bg-gradient-to-r  from-primary via-blue-500 to-pink-500 blur-3xl lg:block'>Salut</div>
      </div>
      {/* Desktop View */}
      <nav className='relative z-10 hidden justify-center py-6 pt-5 sm:flex bg-transparent'>
