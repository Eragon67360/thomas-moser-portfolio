...
export default function Home(){
  ...
  return (
    <div
      ...
      className="bg-transparent overflow-hidden font-montserrat">
      <Head>
      ...
      <main
        className="p-5 text-center flex flex-col bg-fixed bg-black h-screen"        
      >
        ...
        <IndexName/>
          <div className="d-flex justify-content-center align-items-center">
            <div className="text-white">
              ...
              <motion.div
                id="port" href="" className=" unselectable mb-1 md:mb-3 py-5 md:py-10 text-[12vw] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-500 transition-all duration-500">Portfolio</motion.div>
        ...
        <motion.div
                ...
                transition={{ duration: 1,
                              delay: 3 }}
                className="flex py-5 content-center m-auto">
                ...
                <Link
                  ...
                  href="/home"
                  passHref
                  className=" group scale-100 relative m-auto flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium rounded-lg bg-gradient-to-br from-blue-500 to-green-500 transition-scale ease-in-out duration-300 bganimation hover:scale-125 hover:text-white text-white active:brightness-50">
